...
const CreateBookFormInitial = ({ topicRef, handleCreateBook, isGenerating, status }) => {
    ...
    return (
        <>
            <div className="font-semibold text-3xl mb-8">Create My Book</div>
            
            <div className="hidden xl:flex mt-2 mb-1 text-xs ">Example topics:</div>
            <div className="hidden xl:flex flex-wrap gap-3 mb-4">
                <button 
                    onClick={(e) => {
            ...
            <div className="font-semibold text-xl mt-6 h-3">
                {isGenerating && (
